...
def banknifty_2day_before_double_ratio_spread(r1=3, r2=4, n_expiry=104):
    op = OptionsBT()
    op.double_ratio_spread_days_before_expiry('BANKNIFTY', InstrumentType.IndexOptions, 40, 65000, 300, r1=r1, r2=r2, days_before=2, n_expiry=n_expiry)
    return op
...
def banknifty_e2e_ratio_write_at_max_oi(num_lots=5, n_expiry=104):
    op = OptionsBT()
    op.e2e_ratio_write_at_max_oi('BANKNIFTY', InstrumentType.IndexOptions, 40, num_lots, 65000, 200, n_expiry=n_expiry)
    return op

def banknifty_e2e_naked_write_at_max_oi(num_lots=5, n_expiry=104):
    op = OptionsBT()
    op.e2e_naked_write_at_max_oi('BANKNIFTY', InstrumentType.IndexOptions, 40, num_lots, 65000, 200, n_expiry=n_expiry)
    return op
